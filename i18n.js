(() => {
  ...
  const en = {
    ...
    'privacy.summary.p1': "Each application has different practices. Spendly Travel keeps trip data on the device. Operator Ops uses Game Center and, depending on enabled features, its own services, CloudKit, and StoreKit. It may process identity, gameplay, purchase, message, report, and diagnostic data to operate and protect the service; voice chat is not available in the current candidate.",
    ...
    'privacy.operator.p1': "Operator Ops is a tactical game in development, distributed in beta through TestFlight. It uses Game Center for multiplayer and, depending on the features enabled in each version, its own services hosted on Oracle Cloud, CloudKit, and StoreKit. This notice describes the data those features may process; it does not mean every feature is available in every test build.",
    'privacy.game.title': "Identity, matches, and progress",
    'privacy.game.p1': "The app uses the Game Center player identifier and display name. When the service account is enabled, it sends the necessary proof of identity and may retain account identifiers, a display name or public code, sessions, match results, experience, statistics, inventory, and cosmetics in infrastructure hosted on Oracle Cloud. Some preferences and historical data also remain on the device.",
    'privacy.game.p2': "To play, other participants may see your display name, team, equipped appearance, and actions in a match. Game Center separately processes your Apple account data and visibility settings; the developer does not receive your Apple password.",
    'privacy.voice.title': "Voice chat",
    'privacy.voice.p1': "The current candidate does not offer voice chat or request microphone access for gameplay. If that feature is added, this notice will be updated before it is enabled with its audio processing and retention practices.",
    ...
    'privacy.social.title': "Messages, reports, and blocks",
    'privacy.social.p1': "Private match chat is transmitted through GameKit to its participants and remains temporarily in app memory. If service chat is enabled, messages may be retained for communication and moderation. Do not share sensitive information: recipients may keep what you send.",
    'privacy.social.p2': "When you report a player, the selected participant, reason, description you write, and necessary match context are sent. The service may retain the report for review by authorized staff; historical moderation and presence records may remain in CloudKit. Blocks and presence states are associated with an account to manage communication and safety. A report does not automatically impose a sanction, and full conversations or screenshots are not attached automatically.",
    'privacy.purchase.title': "Credits purchases",
    'privacy.purchase.p1': "When Credits packs are enabled, Apple processes payment through the App Store and StoreKit. The app and service use the product, signed transaction, and its status to verify delivery and retain Credits, spending, and inventory history, prevent duplicates, and resolve problems. Prices appear before you confirm a purchase. The battle pass is not part of the current offering.",
    'privacy.purchase.p2': "The developer does not receive your full card number, security code, or Apple password. TestFlight purchases use Apple’s test environment and are not commercial charges.",
    'privacy.testflight.title': "Technical data and TestFlight",
    'privacy.testflight.p1': "Connecting to the service may generate technical logs, including IP address and request data, for operation, security, and diagnostics. Those records may be linked to an account or session. We do not use this data for targeted advertising.",
    'privacy.testflight.p2': "During the beta, Apple may share crash reports, technical data, and feedback or screenshots you choose to send through TestFlight with the developer. Apple processes that data under its own policies. Avoid including sensitive information in feedback or screenshots.",
    'privacy.noads.title': "Advertising and data not requested",
    'privacy.noads.p1': "Operator Ops does not require access to contacts, photos, or precise location for gameplay. It does not ask for card details or your Apple Account password. The candidate described here does not include targeted advertising or advertising tracking tools.",
    'privacy.noads.p2': "The data described is used to operate the game, authenticate users, deliver purchases, moderate, prevent abuse, and maintain the service. It is not sold or combined with other companies’ data for advertising.",
    'privacy.retention.title': "Retention, deletion, and requests",
    'privacy.retention.p1': "Deleting the app removes its local data, but does not by itself delete service, CloudKit, Game Center, TestFlight, or Apple purchase records. When the account feature is available, you can start a deletion request in Settings → Account. The service revokes access and processes associated data; certain records may be retained when needed to reconcile purchases, handle disputes, protect other people, or meet applicable obligations. Deletion does not cancel purchases or delete your Apple account.",
    'privacy.retention.p2': "To ask about, correct, or request deletion of data under the developer’s control, email <a href=\"mailto:cotizacion@sebastianclark.mx\">cotizacion@sebastianclark.mx</a> and identify Operator Ops. Do not send passwords or banking details. Data controlled by Apple can also be managed through <a href=\"https://privacy.apple.com/\">Apple Data and Privacy</a>.",
    'privacy.minors.title': 'Minors and social features',
    'privacy.minors.p1': "Game Center restrictions and parental controls may limit multiplayer, communication, and purchases. Age ratings and family options on the device help determine which features a minor can use.",
    ...
    'privacy.changes.p1': "This notice will be updated when features or data practices change, together with the applicable App Store privacy information. New voice features or other services with different practices will be documented before they are enabled.",
